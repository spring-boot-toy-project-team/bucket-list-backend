...
public class JwtTokenProvider {
    ...
    @Value("spring.jet.accessTokenExpirationDateInMs")
    private Long accessTokenExpiredTime; //5min

    @Value("spring.jet.refreshTokenExpirationDateInMs")
    private Long refreshTokenExpiredTime; //1day
    ...
    public Authentication getAuthentication(String token){
        ...
        if (claims.get(ROLES) == null){
            throw new BusinessLogicException(ExceptionCode.ROLES_IS_NOT_EXISTS);
        }
