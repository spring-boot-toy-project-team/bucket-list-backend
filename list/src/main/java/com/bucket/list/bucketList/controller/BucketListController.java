...
public class BucketListController {
  ...
  // 버킷리스트 등록
  @PostMapping
  public ResponseEntity createBucketList(@Positive @PathVariable("group-id") long groupId,
  ...
  public ResponseEntity getBucketList(@Positive @PathVariable("group-id") long groupId,
  ...
  // 버킷 리스트들 조회
  @GetMapping
  public ResponseEntity getBucketLists(@Positive @PathVariable("group-id") long groupId,
  ...
  public ResponseEntity deleteBucketList(@Positive @PathVariable("group-id") long groupId,
                                         @Positive @PathVariable("bucket-list-id") long bucketListId) {
  ...
  public ResponseEntity updateBucketList(@Positive @PathVariable("group-id") long groupId,
                                         @Positive @PathVariable("bucket-list-id") long bucketListId,
