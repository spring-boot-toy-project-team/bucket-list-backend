...
import com.bucket.list.response.ErrorResponse;
...
public class GlobalAdvice {
    ...
    public ErrorResponse handleConstraintViolationException(
        ...
        final ErrorResponse response = ErrorResponse.of(HttpStatus.BAD_REQUEST, (BindingResult) e.getConstraintViolations());
